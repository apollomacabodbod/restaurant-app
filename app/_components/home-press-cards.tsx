...
export default function HomePressCards(){
  ...
  return (<>
    ...
    <div className="grid grid-cols-1 xl:grid-cols-3  border border-[#50B498] green mx-[2em] lg:mx-[8.4375em] gap-[1.875em] my-[4.3125em] ">

      <div className="flex flex-col border border-[#50B498] green  py-[3.0625em] px-[1.3em] bg-white">
        ...
        <p className="border border-[#50B498] green text-center text-[#333] font-pt-serif text-[1.2rem] lg:text-[1.5rem] not-italic font-bold mt-[1.875em]">The New York Times</p>
      ...
      <div className="flex flex-col border border-[#50B498] green  py-[3.0625em] px-[1.3em] bg-white ">
        ...
        <p className="border border-[#50B498] green text-center text-[#333] font-pt-serif text-[1.2rem] lg:text-[1.5rem] not-italic font-bold mt-[1.875em]">The Guardian</p>

      </div>



      <div className="flex flex-col border border-[#50B498] green pt-[3.0625em] px-[1.3em] bg-white">
        ...
        <p className="border border-[#50B498] green text-center text-[#333] font-pt-serif text-[1.2rem] lg:text-[1.5rem] not-italic font-bold mt-[1.875em]">The Wall Street Journal</p>
