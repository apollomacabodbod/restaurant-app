  ...
  return (<>
    ...
    <div className="flex flex-col border border-[#50B490] green">
      ...
      <div className="flex items-center justify-center">
        ...
        <button className="border border-[#50B490] green py-[0.75em] px-[2.84375em] bg-[#6327EB] text-[#FFF] rounded-[0.1875em] font-roboto not-italic font-normal text-[1.125rem] mb-[5em] cursor-pointer opacity-70 hover:opacity-100 transition-opacity duration-1000 ease-in-out active:scale-95 active:transition-transform active:duration-200 active:ease-out">Full menu</button>
