        ...
        <div className="sm:flex sm:items-center sm:justify-between transition-all duration-1000 ease-in-out">
          ...
          <div className="flex flex-col  ">
            ...
            <div className="relative">
              ...
              <p className="text-[#FFF] dark:text-[#FFF] text-[3.5em]  sm:text-[3.1rem]  md:text-[4rem]  lg:text-[4rem] xl:text-[4.5rem]  whitespace-nowrap border border-[#50B498] font-bold  font-pt-serif leading-[1.2em] tracking-[0.01em]  transition-all duration-1000 ease-in-out opacity-70 hover:opacity-100 ">
               Welcome 
