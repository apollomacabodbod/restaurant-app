...
export default function HomeCube() {
  return (
    <>
      <div className="flex flex-col  mt-[3.6875em]   lg:mt-[5.8125em]  mx-[2em] lg:mx-[8.4375em]  transition-all duration-1000 ease-in-out ">
            ...
            <div className="relative">
              ...
              <div className="flex items-center">
                ...
                <Image
                  ...
                  className=" absolute top-[4.5em]  sm:top-[1.9em]  xl:top-[2.4em]   left-[14.5em]   sm:left-[13.5em] md:left-[16em]  lg:left-[16em] xl:left-[23em]  -translate-x-1/2 -translate-y-1/2  transition-all duration-1000 ease-in-out"
                />
