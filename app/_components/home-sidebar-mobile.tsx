...
const Sidebar: FC<SidebarProps> = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <div
      ref={sidebarRef} 
      className={`lg:hidden fixed top-0 right-0 w-64 min-h-screen z-40 bg-center bg-cover bg-no-repeat bg-fixed bg-[url('/hero-background.svg')] transition-transform duration-300 ${
