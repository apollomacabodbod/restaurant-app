      ...
      <Carousel setApi={setApi} className="w-full overflow-hidden">
        <CarouselContent className="flex snap-x snap-mandatory  scroll-smooth">
          ...
          <CarouselItem className="flex-shrink-0 w-full snap-start transition-all duration-1000 ease-in-out transform-gpu">
            <div className="flex flex-col mx-[2em] lg:mx-[4.4375em] xl:mx-[8.4375em] border border-[#50B498] green my-[2.4375em] transition-all duration-1000 ease-in-out transform ">
              <div className="lg:flex lg:items-center lg:justify-center  lg:bg-white lg:gap-[3em] xl:gap-[4.125em] border border-[#50B498] green">
                ...
                <div className="flex flex-col border border-[#50B498] green bg-white px-[1.875em]  py-[3em] lg:py-[1em] ">
                  <p className="text-[#333] border border-[#50B498] green font-roboto text-[1.25rem] not-italic font-light   ">Upcoming</p>
                  <p className="text-[#333] border border-[#50B498] green font-pt-serif text-[2rem] lg:text-[2.5rem] not-italic font-bold ">Coffee Night</p>
