...
export default function HomeCoffeNight(){
  ...
  return (
    ...
    <>
      ...
      <motion.div className="flex flex-col mx-[2em] lg:mx-[5.4375em] xl:mx-[8.4375em] border border-[#50B498] green my-[2.4375em] transition-all duration-1000 ease-in-out"
